...
module.exports = {
SESSION_ID: process.env.SESSION_ID  'V
    VAJIRA-MD=PckBRDib#oVhZfJ1XJyddotBIU5313L7eR_wrCQByd8A5JiDO7uc' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER '+923091619697' : process.env.OWNER_NUMBER,   
